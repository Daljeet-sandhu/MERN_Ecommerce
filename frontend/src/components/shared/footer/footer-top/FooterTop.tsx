                ...
                <div className={classes.footerInfo}>
                    <div className={classes.social}>
                        ...
                        <div className={classes.socialLinks}>
                            <Link to='https://github.com/daljeet-sandhu'>
                    ...
                    <ul className={classes.info}>
                        <li>
                            <Link to='https://github.com/daljeet-sandhu'>About</Link>
                        </li>
                        <li>
                            <Link to='https://github.com/daljeet-sandhu'>Partnership</Link>
                        </li>
                        <li>
                            <Link to='https://github.com/daljeet-sandhu'>Information</Link>
                        </li>
                        <li>
                            <Link to='https://github.com/daljeet-sandhu'>For users</Link>
                        </li>
                        <div className={classes.getApp}>
                            <li>
                                <Link to='https://github.com/daljeet-sandhu'>Get app</Link>
                            </li>
